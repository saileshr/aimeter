...
- [ ] CLI: `agentmeter report` — terminal cost summary from event files
- [ ] CLI: `agentmeter models` — list all known models and pricing
...
- [ ] HTTP exporter (POST events to AgentMeter cloud)
